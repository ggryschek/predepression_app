...
translations = {
    "English": {
        ...
        "medication_slider": "How many different types of prescription medications {have you/has the patient} taken in the past 30 days?",
        "medication_help": "Consider only medications prescribed by a doctor or other health care professional. Do not consider medications you have taken on your own. If 5 or more, choose 5. If unsure, check 'Don't know' above",
    ...
    "Español": {
        ...
        "medication_slider": "¿¿Cuántos tipos diferentes de medicamentos recetados ha tomado usted/ha tomado el paciente en los últimos 30 días?",
        "medication_help": "Considere solo los medicamentos recetados por un médico u otro profesional de la salud. No considere los medicamentos que haya tomado por su cuenta. Si 5 o más, elige 5. Si no está seguro, marque 'No sé' arriba",
    ...
    "Português Br": {
        ...
        "medication_slider": "Quantos tipos diferentes de medicamentos prescritos {você/o paciente} tomou nos últimos 30 dias?",
        "medication_help": "Considere apenas medicamentos prescritos por um médico ou outro profissional de saúde. Não considere medicamentos que você tomou por conta própria. Se forem 5 ou mais, escolha 5. Se não tiver certeza, marque 'Não sei' acima",
